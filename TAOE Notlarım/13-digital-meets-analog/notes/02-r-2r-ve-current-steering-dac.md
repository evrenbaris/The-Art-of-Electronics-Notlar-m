# R-2R ve Current Steering DAC

## 1. Amaç

Farklı DAC mimarileri hız, doğruluk ve glitch açısından farklıdır.
...
| English | Türkçe | Not |
|---|---|---|
| R-2R | R-2R | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Current | Current | Konu içinde tanımlanacak |
| Steering | Steering | Konu içinde tanımlanacak |
| DAC | DAC | Konu içinde tanımlanacak |
