...
Nyquist üstündeki bileşenler yanlış frekans olarak görünür; anti-alias filtre gerekir.
...
| English | Türkçe | Not |
|---|---|---|
| Örnekleme | Örnekleme | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Aliasing | Aliasing | Konu içinde tanımlanacak |
