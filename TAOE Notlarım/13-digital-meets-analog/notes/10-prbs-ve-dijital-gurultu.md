# PRBS ve Dijital Gürültü

## 1. Amaç

Pseudo-random diziler test ve yayılma için kullanılır; spektrumları belirli kurallara uyar.
...
- [ ] Offset, bias current, noise veya settling süresini hata bütçesine eklememek.
...
| English | Türkçe | Not |
|---|---|---|
| PRBS | PRBS | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Dijital | Dijital | Konu içinde tanımlanacak |
| Gürültü | Gürültü | Konu içinde tanımlanacak |
