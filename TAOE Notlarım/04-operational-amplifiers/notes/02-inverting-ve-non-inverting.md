# Inverting ve Non-Inverting

## 1. Amaç

Kazanç direnç oranıyla belirlenir; giriş empedansı ve faz ihtiyaca göre seçilir.
...
| English | Türkçe | Not |
|---|---|---|
| Inverting | Inverting | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Non-Inverting | Non-Inverting | Konu içinde tanımlanacak |
