# Buffer ve Difference Amplifier

## 1. Amaç

Buffer yüklemeyi azaltır; difference amplifier iki sinyal farkını alır ama direnç eşleşmesi ister.
...
| English | Türkçe | Not |
|---|---|---|
| Buffer | Buffer | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Difference | Difference | Konu içinde tanımlanacak |
| Amplifier | Amplifier | Konu içinde tanımlanacak |
