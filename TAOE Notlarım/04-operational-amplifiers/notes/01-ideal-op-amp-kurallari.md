# İdeal Op-Amp Kuralları

## 1. Amaç

Negatif geri besleme altında girişler eşitlenir ve giriş akımı ihmal edilir; bu bir sonuçtur, varsayım değil.
...
| English | Türkçe | Not |
|---|---|---|
| İdeal | İdeal | Konu içinde tanımlanacak |
| Op-Amp | Op-Amp | Konu içinde tanımlanacak |
| Kuralları | Kuralları | Konu içinde tanımlanacak |
