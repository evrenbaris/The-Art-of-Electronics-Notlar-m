# Op-Amp Gerçek Davranışı

## 1. Amaç

Offset, bias current, noise, GBW, slew rate ve output current birlikte değerlendirilir.
...
| Gerçek | Gerçek | Konu içinde tanımlanacak |
| Davranışı | Davranışı | Konu içinde tanımlanacak |
