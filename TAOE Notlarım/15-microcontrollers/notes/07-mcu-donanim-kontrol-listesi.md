# MCU Donanım Kontrol Listesi

## 1. Amaç

Reset, boot mode, decoupling, crystal, programming header ve protection şematikte eksiksiz olmalıdır.
...
| Donanım | Donanım | Konu içinde tanımlanacak |
