# MCU ADC/DAC Periferikleri

## 1. Amaç

MCU iç ADC kullanışlıdır ama referans, sampling ve giriş empedansı limitlidir.
...
| English | Türkçe | Not |
|---|---|---|
| MCU | MCU | Konu içinde tanımlanacak |
| ADC/DAC | ADC/DAC | Konu içinde tanımlanacak |
| Periferikleri | Periferikleri | Konu içinde tanımlanacak |
