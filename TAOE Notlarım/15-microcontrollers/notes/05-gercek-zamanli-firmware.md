# Gerçek Zamanlı Firmware

## 1. Amaç

Loop, interrupt ve RTOS tasarımı deterministik zaman gereksinimlerine göre seçilir.
...
| Zamanlı | Zamanlı | Konu içinde tanımlanacak |
| Firmware | Firmware | Konu içinde tanımlanacak |
