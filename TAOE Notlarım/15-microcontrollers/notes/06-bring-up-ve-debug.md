...
İlk kart ayağa kaldırmada güç sırası, clock, reset, JTAG ve basit GPIO testleri izlenir.
...
| English | Türkçe | Not |
|---|---|---|
| Bring-up | Bring-up | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Debug | Debug | Konu içinde tanımlanacak |
