# Senkronizer ve Metastability

## 1. Amaç

Asenkron sinyal clock domain içine alınırken metastability riski yönetilir.
...
| English | Türkçe | Not |
|---|---|---|
| Senkronizer | Senkronizer | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Metastability | Metastability | Konu içinde tanımlanacak |
