...
Devre dilinin temelini kur: gerilim iki nokta arasında, akım elemanın içinden, direnç ise ilişkiyi belirleyen elemandır.
...
- discrete giriş pull-up/pull-down
- şase dönüş akımı yorumlama
...
| English | Türkçe | Not |
|---|---|---|
| Gerilim, | Gerilim, | Konu içinde tanımlanacak |
| Akım | Akım | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Direnç | Direnç | Konu içinde tanımlanacak |
