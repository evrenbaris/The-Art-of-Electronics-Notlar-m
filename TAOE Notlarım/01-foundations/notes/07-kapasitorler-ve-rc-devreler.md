# Kapasitörler ve RC Devreler

## 1. Amaç

Kapasitör gerilim değişimine karşı çıkar; RC zaman sabiti devrenin hızını belirler.
...
| English | Türkçe | Not |
|---|---|---|
| Kapasitörler | Kapasitörler | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| RC | RC | Konu içinde tanımlanacak |
| Devreler | Devreler | Konu içinde tanımlanacak |
