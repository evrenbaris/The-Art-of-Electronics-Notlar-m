...
Eşdeğer direnç hesabını sezgisel yap; büyük-küçük direnç yaklaşımını kullan.
...
| English | Türkçe | Not |
|---|---|---|
| Seri | Seri | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Paralel | Paralel | Konu içinde tanımlanacak |
| Dirençler | Dirençler | Konu içinde tanımlanacak |
