...
Devrede bir elemanın elektriksel zorlanmasını yalnız gerilimle değil, akım ve güçle birlikte değerlendir.
...
| English | Türkçe | Not |
|---|---|---|
| Ohm | Ohm | Konu içinde tanımlanacak |
| Kanunu | Kanunu | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Güç | Güç | Konu içinde tanımlanacak |
