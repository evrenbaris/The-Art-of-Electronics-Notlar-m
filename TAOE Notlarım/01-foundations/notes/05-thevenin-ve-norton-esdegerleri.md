...
Karmaşık kaynak-direnç ağını tek kaynak + tek direnç gibi düşünerek yükleme etkisini gör.
...
- sensör çıkışı yüklenmesi
- ölçüm cihazı input impedance
- harici hat sürme
...
| English | Türkçe | Not |
|---|---|---|
| Thevenin | Thevenin | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Norton | Norton | Konu içinde tanımlanacak |
| Eşdeğerleri | Eşdeğerleri | Konu içinde tanımlanacak |
