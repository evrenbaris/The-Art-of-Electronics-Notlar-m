# Sinyaller, Genlik ve dB

## 1. Amaç

Sinyali zaman ve frekans alanında düşün; dB oran dilidir.
...
| English | Türkçe | Not |
|---|---|---|
| Sinyaller, | Sinyaller, | Konu içinde tanımlanacak |
| Genlik | Genlik | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| dB | dB | Konu içinde tanımlanacak |
