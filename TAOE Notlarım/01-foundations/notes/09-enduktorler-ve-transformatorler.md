# Endüktörler ve Transformatörler

## 1. Amaç

Endüktör akım değişimine karşı çıkar; enerji manyetik alanda depolanır.
...
| English | Türkçe | Not |
|---|---|---|
| Endüktörler | Endüktörler | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Transformatörler | Transformatörler | Konu içinde tanımlanacak |
