...
AC analizde direnç, kapasitör ve endüktör frekansa bağlı empedans olarak ele alınır.
...
| English | Türkçe | Not |
|---|---|---|
| Empedans | Empedans | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Reaktans | Reaktans | Konu içinde tanımlanacak |
