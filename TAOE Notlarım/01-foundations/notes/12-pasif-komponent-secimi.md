# Pasif Komponent Seçimi

## 1. Amaç

Gerçek komponent ideal değildir; tolerans, sıcaklık, ESR, ESL, güç ve gerilim limiti tasarımı belirler.
...
| English | Türkçe | Not |
|---|---|---|
| Pasif | Pasif | Konu içinde tanımlanacak |
| Komponent | Komponent | Konu içinde tanımlanacak |
| Seçimi | Seçimi | Konu içinde tanımlanacak |
