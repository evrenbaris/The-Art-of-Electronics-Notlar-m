# Settling, Slew Rate ve Dinamik Hata

## 1. Amaç

ADC öncesi devre yalnız doğru değere değil, zamanında doğru değere ulaşmalıdır.
...
| English | Türkçe | Not |
|---|---|---|
| Settling, | Settling, | Konu içinde tanımlanacak |
| Slew | Slew | Konu içinde tanımlanacak |
| Rate | Rate | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Dinamik | Dinamik | Konu içinde tanımlanacak |
