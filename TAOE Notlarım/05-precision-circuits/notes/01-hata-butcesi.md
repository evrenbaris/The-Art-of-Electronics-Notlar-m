...
Hassas tasarımda her hata kaynağını ppm, yüzde veya volt cinsinden bütçeye yaz.
...
- `total error≈RSS veya worst-case`
...
| English | Türkçe | Not |
|---|---|---|
| Hata | Hata | Konu içinde tanımlanacak |
| Bütçesi | Bütçesi | Konu içinde tanımlanacak |
