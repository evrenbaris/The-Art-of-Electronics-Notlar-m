# Direnç Toleransı ve Drift

## 1. Amaç

Kazanç doğruluğu çoğu zaman op-amp değil direnç oranı ile sınırlanır.
...
| Toleransı | Toleransı | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Drift | Drift | Konu içinde tanımlanacak |
