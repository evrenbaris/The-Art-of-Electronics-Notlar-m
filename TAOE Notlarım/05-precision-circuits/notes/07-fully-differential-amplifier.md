...
Diferansiyel ADC sürmede common-mode seviyesi ve simetrik çıkış önemlidir.
...
| English | Türkçe | Not |
|---|---|---|
| Fully | Fully | Konu içinde tanımlanacak |
| Differential | Differential | Konu içinde tanımlanacak |
