...
Ortak mod ve besleme değişimleri ölçüme sızabilir; dB değerini gerçek hataya çevir.
...
| English | Türkçe | Not |
|---|---|---|
| CMRR | CMRR | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| PSRR | PSRR | Konu içinde tanımlanacak |
