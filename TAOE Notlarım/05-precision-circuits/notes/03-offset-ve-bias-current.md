# Offset ve Bias Current

## 1. Amaç

Küçük sinyallerde giriş offseti ve bias akımı doğrudan ölçüm hatasına dönüşür.
...
| English | Türkçe | Not |
|---|---|---|
| Offset | Offset | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| Bias | Bias | Konu içinde tanımlanacak |
