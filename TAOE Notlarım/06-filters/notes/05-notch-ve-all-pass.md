...
Belirli bir bozucuyu bastırmak veya fazı ayarlamak için özel filtreler kullanılır.
...
| English | Türkçe | Not |
|---|---|---|
| Notch | Notch | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| All-Pass | All-Pass | Konu içinde tanımlanacak |
