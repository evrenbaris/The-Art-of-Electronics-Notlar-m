...
Düz genlik, iyi zaman cevabı veya keskin geçiş arasında tercih yapılır.
...
| English | Türkçe | Not |
|---|---|---|
| Butterworth, | Butterworth, | Konu içinde tanımlanacak |
| Bessel, | Bessel, | Konu içinde tanımlanacak |
| Chebyshev | Chebyshev | Konu içinde tanımlanacak |
