...
RS-485 diferansiyel ve çok noktalı yapı için uygundur; terminasyon ve bias gerekir.
...
| English | Türkçe | Not |
|---|---|---|
| RS-232 | RS-232 | Konu içinde tanımlanacak |
| / | / | Konu içinde tanımlanacak |
| RS-485 | RS-485 | Konu içinde tanımlanacak |
