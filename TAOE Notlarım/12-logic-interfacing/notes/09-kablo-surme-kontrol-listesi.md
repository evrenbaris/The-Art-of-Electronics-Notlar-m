# Kablo Sürme Kontrol Listesi

## 1. Amaç

Sinyal hızı, kablo tipi, empedans, return path, shield ve connector birlikte seçilir.
...
- [ ] Terminasyon, common-mode aralığı ve fail-safe bias gereksinimini unutmak.
...
| English | Türkçe | Not |
|---|---|---|
| Kablo | Kablo | Konu içinde tanımlanacak |
| Sürme | Sürme | Konu içinde tanımlanacak |
| Kontrol | Kontrol | Konu içinde tanımlanacak |
| Listesi | Listesi | Konu içinde tanımlanacak |
