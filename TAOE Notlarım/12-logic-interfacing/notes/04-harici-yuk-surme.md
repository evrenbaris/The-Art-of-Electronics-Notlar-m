...
Logic pin doğrudan yük sürmek için değil, sürücü devreyi kontrol etmek için kullanılır.
...
| English | Türkçe | Not |
|---|---|---|
| Harici | Harici | Konu içinde tanımlanacak |
| Yük | Yük | Konu içinde tanımlanacak |
