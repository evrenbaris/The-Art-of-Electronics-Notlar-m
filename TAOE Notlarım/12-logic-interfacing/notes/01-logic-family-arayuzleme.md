# Logic Family Arayüzleme

## 1. Amaç

Farklı logic aileleri gerilim, eşik ve akım uyumluluğu açısından kontrol edilir.
...
| English | Türkçe | Not |
|---|---|---|
| Logic | Logic | Konu içinde tanımlanacak |
| Family | Family | Konu içinde tanımlanacak |
| Arayüzleme | Arayüzleme | Konu içinde tanımlanacak |
