# Optokuplör ve İzolasyon

## 1. Amaç

İzolasyon ground loop ve güvenlik için kullanılır; hız ve CTR sınırlıdır.
...
| English | Türkçe | Not |
|---|---|---|
| Optokuplör | Optokuplör | Konu içinde tanımlanacak |
| ve | ve | Konu içinde tanımlanacak |
| İzolasyon | İzolasyon | Konu içinde tanımlanacak |
