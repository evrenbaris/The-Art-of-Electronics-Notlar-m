# HDL ile Donanım Düşünme

## 1. Amaç

Verilog/VHDL kodu yazılım değil, sentezlenen donanım tarifidir.
...
| English | Türkçe | Not |
|---|---|---|
| HDL | HDL | Konu içinde tanımlanacak |
| ile | ile | Konu içinde tanımlanacak |
| Donanım | Donanım | Konu içinde tanımlanacak |
| Düşünme | Düşünme | Konu içinde tanımlanacak |
