...
Düşük distorsiyonlu sinüs için genlik kontrolü ve seçici ağ gerekir.
...
| English | Türkçe | Not |
|---|---|---|
| Sinüs | Sinüs | Konu içinde tanımlanacak |
| Osilatörleri | Osilatörleri | Konu içinde tanımlanacak |
