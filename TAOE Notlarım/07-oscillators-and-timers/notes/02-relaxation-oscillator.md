...
Kapasitör şarj/deşarj ve eşik karşılaştırma ile kare/üçgen dalga üretir.
...
| English | Türkçe | Not |
|---|---|---|
| Relaxation | Relaxation | Konu içinde tanımlanacak |
| Oscillator | Oscillator | Konu içinde tanımlanacak |
