...
Gerilim kazancı yaklaşık 1, akım kazancı yüksek; tampon olarak kullanılır.
...
| English | Türkçe | Not |
|---|---|---|
| Emitter | Emitter | Konu içinde tanımlanacak |
| Follower | Follower | Konu içinde tanımlanacak |
