...
Yüksek kaynak empedansında düşük input current nedeniyle FET avantajlıdır.
...
| English | Türkçe | Not |
|---|---|---|
| JFET/FET | JFET/FET | Konu içinde tanımlanacak |
| Gürültüsü | Gürültüsü | Konu içinde tanımlanacak |
