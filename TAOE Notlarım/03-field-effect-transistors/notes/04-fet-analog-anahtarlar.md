# FET Analog Anahtarlar

## 1. Amaç

Ron, charge injection, leakage ve capacitance gerçek performansı belirler.
...
| English | Türkçe | Not |
|---|---|---|
| FET | FET | Konu içinde tanımlanacak |
| Analog | Analog | Konu içinde tanımlanacak |
| Anahtarlar | Anahtarlar | Konu içinde tanımlanacak |
