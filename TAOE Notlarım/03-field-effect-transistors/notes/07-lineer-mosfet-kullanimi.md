# Lineer MOSFET Kullanımı

## 1. Amaç

MOSFET lineer bölgede SOA ile sınırlanır; sadece Rds(on) bakmak yetmez.
...
- [ ] SOA, inrush veya switching kayıplarını yalnız Rds(on)/nominal akımla değerlendirmek.
...
| English | Türkçe | Not |
|---|---|---|
| Lineer | Lineer | Konu içinde tanımlanacak |
| MOSFET | MOSFET | Konu içinde tanımlanacak |
| Kullanımı | Kullanımı | Konu içinde tanımlanacak |
