# Power MOSFET Anahtar

## 1. Amaç

MOSFET anahtarlamada gate charge, Rds(on), SOA ve ısı birlikte düşünülür.
...
| English | Türkçe | Not |
|---|---|---|
| Power | Power | Konu içinde tanımlanacak |
| MOSFET | MOSFET | Konu içinde tanımlanacak |
| Anahtar | Anahtar | Konu içinde tanımlanacak |
